                    ...
                    <div class="col-10">
                        <div class="row">
                            <div class="col direktori-admin">
                                <span><a href="beranda-admin.php">Beranda</a> > <a href="data-penerimaan-donasi.php">Data Penerimaan Donasi</a> > Detail Data Penerimaan Donasi</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                            ...
                                            <div class="col judul-admin">
                                                <div>
                                                    <span class="text-laporan">
                                                        Data Penerimaan Donasi Februari 2021
                                                    </span>
                                                    <hr class="hr5">
                                                </div>
                                            </div>
