...
if (isset($_POST['delete'])) {
    if (!empty($_POST['idtransaksi'])) {
        ...
        $query = "DELETE FROM transaksipanti WHERE id IN(" . implode(",", $idtransaksi) . ")";
        $sql = $pdo->prepare($query);
        $sql->execute();
        header("location: data-penyaluran-donasi.php");
                    ...
                    <div class="col-10">
                        <div class="row">
                            <div class="col direktori-admin">
                                <span><a href="beranda-admin.php">Beranda</a> > Data Penyaluran Donasi</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="row">
                                            <div class="col table-admin">
                                                <form method="post" action="data-penyaluran-donasi.php">
                                                    <div class="CRUD">
                                                        <span><a href="tambah-data-penyaluran-donasi.php">Tambah</a></span>
