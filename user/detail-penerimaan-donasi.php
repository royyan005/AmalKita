    ...
    $htg = DB::query('SELECT SUM(jumlah) AS total FROM transaksipenerimaan');
    $total = 0;
    ...
    <section class="direktori">
        <div class="bgdirektori">
            <div class="container-fluid">
                <div class="row">
                    <div class="col">
                        <span class="tulisandirektori"><a href="beranda.php">Beranda</a> > <a href="laporan-penerimaan.php">Laporan</a> > Detail</span>
                    </div>
                    <div class="col bt-direktori">
                        <a class="bt-white" href="https://api.whatsapp.com/send?phone=6285801573072"><i class="far fa-flag"></i>&nbsp; Laporkan</a>
                ...
                <div class="row">
                    <div class="col text-laporan">
                        <div class="judul-laporan">
                            Laporan Penerimaan Februari 2021
                        </div>
                        <div class="line-laporan">
                        </div>
                        <div class="desc-laporan">
                            Berikut adalah laporan donasi yang telah kami terima.
                        </div>
                    </div>
                </div>
                <div class="row">
                    <table class="table-user">
                        ...
                        ?>
                        <tr id="tfoot">
                            <td id="total-donasi" colspan="3">Total Donasi</td>
